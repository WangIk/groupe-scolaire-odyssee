          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            >
              ...
              <p className="text-gray-400 font-work-sans">
                Votre partenaire de confiance pour tous vos besoins en outillage professionnel 
            ...
            >
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3 text-gray-400">
                  <svg className="h-6 w-6 mt-1 flex-shrink-0 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                  <span>Rue des Mandarines, Bd Chefchaouni, Casablanca 20250</span>
                </li>
                ...
                <li className="flex items-center gap-3 text-gray-400">
                  ...
                  <span>jackindustries.maroc@gmail.com</span>
                </li>
              </ul>
            </motion.div>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm text-center md:text-left">
              © {currentYear} Jack Industries. Tous droits réservés.
            </p>
